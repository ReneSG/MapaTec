$(document).ready(function(){
	...
	$('#b1').click(function(){
	    ...
	    $('#R1').velocity({marginLeft:60, opacity:1, blur:0})
	...
	$('#b2').click(function(){
	    ...
	    $("#b6").attr('disabled','disabled');
	    $('#R2').velocity({marginLeft:60, opacity:1, blur:0})
	...
	$('#b3').click(function(){
	    ...
	    $("#b6").velocity({opacity:0, blur:30}, 200);
	    $("#b6").attr('disabled','disabled');
	    $('#R3').velocity({marginLeft:60, opacity:1, blur:0})
		...
		$('#b4').click(function(){
	    $('#b4').velocity({marginLeft: -5}, {duration:1500, easing:"easelnOutExpo"});
	    $("#b2").velocity({opacity:0, blur:30});
	    $("#b2").attr('disabled','disabled');
	    $("#b3").velocity({opacity:0, blur:30});
	    $("#b3").attr('disabled','disabled');
	    ...
	    $("#b6").velocity({opacity:0, blur:30});
	    $("#b6").attr('disabled','disabled');
	    $('#R4').velocity({marginLeft:60, opacity:1, blur:0})
		$("#R4").removeAttr('disabled');
	  
		$('#R4').click(function(){
			$("#b4").velocity({marginLeft: 175}, {duration:1500, easing:"easelnOutExpo"});
	...
	$('#b5').click(function(){
	    $('#b5').velocity({marginLeft: -10}, {duration:1500, easing:"easelnOutExpo"});
	    $("#b1").velocity({opacity:0, blur:30}, 200);
	    $("#b1").attr('disabled','disabled');
	    $("#b3").velocity({opacity:0, blur:30}, 200);
	    $("#b3").attr('disabled','disabled');
	    ...
	    $("#b6").velocity({opacity:0, blur:30}, 200);
	    $("#b6").attr('disabled','disabled');
	    $('#R5').velocity({marginLeft:60, opacity:1, blur:0})
		$("#R5").removeAttr('disabled');
	
		$('#R5').click(function(){
			$("#b5").velocity({marginLeft: 550}, {duration:1500, easing:"easelnOutExpo"});
	...
	$('#b6').click(function(){
	    $('#b6').velocity({marginLeft: -15}, {duration:1500, easing:"easelnOutExpo"});
	    $("#b1").velocity({opacity:0, blur:30}, 200);
	    $("#b1").attr('disabled','disabled');
	    $("#b2").velocity({opacity:0, blur:30}, 200);
	    $("#b2").attr('disabled','disabled');
	    ...
	    $("#b3").velocity({opacity:0, blur:30}, 200);
	    $("#b3").attr('disabled','disabled');
	    $('#R6').velocity({marginLeft:60, opacity:1, blur:0})
		$("#R6").removeAttr('disabled');
	
		$('#R6').click(function(){
			$("#b6").velocity({marginLeft: 925}, {duration:1500, easing:"easelnOutExpo"});
